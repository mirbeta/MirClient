...
type
  ...
  private
    ...
    procedure DoRehash(const iCount: Integer); inline;
    procedure Rehash;
    procedure NeedRebuildBucketCounts; inline;
  protected
...
function CRC8(const S: string): Byte; inline;
var
...
function CRC16(S: PByteArray; iCount: Integer; OldCRC: Word = 0): Word; inline;
var
...
function CRC32(S: PByteArray; iCount: Integer; OldCRC: Cardinal = 0): Cardinal; inline;
var
  I, Step, DecCount: Integer;
begin
  Result := Crc32Start;
...
var
  LStr1, LStr2, LStr1Char1, LStr2Char1, LLength1, LLength2,
    LCompInd, LLengthDif, LChars1, LChars2: NativeInt;
begin
  LStr1 := NativeInt(S1);
  LStr2 := NativeInt(S2);
  if LStr1 <> LStr2 then
