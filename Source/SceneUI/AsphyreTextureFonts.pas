...
uses
  Windows, Types, Classes, Graphics, SysUtils, PXL.Devices, PXL.SwapChains, PXL.Canvas,
  Math, PXL.Textures, PXL.Providers, uGameEngine, uCommon;
...
procedure WidthW(AWidth, ABitCount: Integer; var APicth: Integer);
begin
