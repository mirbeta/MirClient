...
*                                                                            *
*  Copyright (c) 2004-2014 RealThinClient (http://www.realthinclient.com)    *
...
// {$IFDEF AUTOREFCOUNT} {$DEFINE RTC_USEZLIB} {$ENDIF}
...
function ZCompress_Ex(const inBuffer: RtcByteArray; level: TZCompressionLevel):RtcByteArray;
{$IFDEF IDE_XE4up}
  begin
