...
{$IFDEF WINDOWS}
  {$MESSAGE WARN 'rtcNixSock unit is ONLY for Non-Windows platforms.'}
{$ENDIF}
...
var
  ...
  function GetAddr(const IP, port: AnsiString; Hints: TAddrInfo; var Sin: TSockAddr): integer;
  var
