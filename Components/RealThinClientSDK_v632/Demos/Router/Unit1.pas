...
uses
  ...
  rtcTypes, rtcLog, rtcSyncObjs, StdCtrls, Spin, memXObjList, rtcFastStrings,
  rtcDataRoute, rtcThrPool, ExtCtrls;
...
procedure TRtcRouterMainForm.GetDataRequest(Sender:TRtcDataServer; var DataRequest: TRtcDataRequest; const tip:RtcString);
  ...
  try
    ...
    try
      ...
      else if ReqCount<MaxReqCount then
        begin
        Inc(ReqCount);
        makenew:=True;
        end;
