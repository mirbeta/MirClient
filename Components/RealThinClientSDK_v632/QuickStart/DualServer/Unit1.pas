...
uses
  ...
  Dialogs, rtcDataSrv, rtcConn, rtcHttpSrv, rtcInfo;
...
procedure TForm1.FormDestroy(Sender: TObject);
  var
    w:longword;
  begin
  HttpServer80.StopListen;
  HttpServer443.StopListen;
  HttpServer8080.StopListen;
  HttpServer1975.StopListen;

  w:=GetTickCount;
  while (HttpServer80.TotalConnectionCount>0) and (GetTickCount-w<10000) do
    begin
