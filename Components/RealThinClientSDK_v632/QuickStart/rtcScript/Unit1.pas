...
uses
  ...
  rtcScript, rtcDataSrv, rtcHttpSrv;
...
procedure TForm1.Button1Click(Sender: TObject);
  ...
  lblTime.Caption:='Running the script ...';
  lblTime.Update;
  try
    x:=nil;
    try
      ...
      x:=RtcScriptEngine1.Execute(DummyConnection, RtcScriptEngine1.Compile(s));
      // Get execution result as a string
      s:=x.asText;
      tc:=GetTickCount-tc;
