...
uses
  ...
  cxButtons, dxBevel, cxTextEdit, cxMaskEdit, cxDropDownEdit, dxRibbon, dxForms;

type
  TRibbonDemoStyle = (rdsOffice2007, rdsOffice2010, rdsOffice2013, rdsOffice2016, rdsOffice2016Tablet, rdsOffice2019, rdsScenic);
