inherited fmVirtualModeDemoMain: TfmVirtualModeDemoMain
  Left = 232
  Top = 114
  Caption = 'ExpressQuantumTreeList VirtualModeDemo '
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited lscrip: TLabel
    Height = 48
    Caption = 
       'Use the TreeList to work in Virtual Mode with a custom data structure ' +
       'containing about 100,000 nodes. Data is created and updated on the fly ' +
       'using specially implemented event handlers. See Help/About to learn more.'
  end
  ...
  object TreeList: TcxVirtualTreeList [2]
    ...
    OnGetChildCount = TreeListGetChildCount
    OnGetNodeValue = TreeListGetNodeValue
    OnSetNodeValue = TreeListGetNodeValue
