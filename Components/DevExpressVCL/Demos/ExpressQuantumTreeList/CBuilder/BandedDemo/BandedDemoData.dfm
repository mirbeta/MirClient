object BandedDemoDataDM: TBandedDemoDataDM
  ...
  object mdDepartments: TdxMemData
    ...
    object mdDepartmentsManager: TStringField
      FieldKind = fkLookup
      FieldName = 'Manager'
      LookupDataSet = mdPersons
      LookupKeyFields = 'ID'
      LookupResultField = 'Name'
      KeyFields = 'MANAGERID'
      Lookup = True
    end
    object mdDepartmentsManagerPhone: TStringField
      FieldKind = fkLookup
    ...
    object mdDepartmentsManagerEmail: TStringField
      FieldKind = fkLookup
