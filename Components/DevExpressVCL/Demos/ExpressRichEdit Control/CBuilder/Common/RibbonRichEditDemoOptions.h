...
#ifndef RibbonRichEditDemoOptionsH
#define RibbonRichEditDemoOptionsH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
public:		// User declarations
	...
	void LoadOptions(TScreenTipOptions AScreenTipOptions,
		TRibbonDemoStyle AStyle, TdxRibbonColorSchemeAccent AColorSchemeAccent);
	void SaveOptions(TScreenTipOptions *AScreenTipOptions,
		TRibbonDemoStyle *AStyle, TdxRibbonColorSchemeAccent *AColorSchemeAccent);
