...
uses
  ...
  cxLookAndFeelPainters, BaseForm, cxContainer, cxLabel, cxGridCardView, dxSkinsCore, dxSkinDevExpressDarkStyle,
  dxSkinTheBezier, cxNavigator, cxDataControllerConditionalFormattingRulesManagerDialog;
...
begin
  ...
  FilmsDemoDM.edsFilmsPersons.DataSetField := nil;
  FilmsDemoDM.edsFilmsPersons.EntityName := 'TFilmsPersons';
  FilmsDemoDM.edsFilmsPersons.Open;
...
begin
  ...
  FilmsDemoDM.edsFilmsPersons.DataSetField := FilmsDemoDM.edsFilmsFilmPersons;
