...
uses
  ...
  BaseForm, cxLabel, dxSkinsCore, dxSkinDevExpressDarkStyle, dxSkinTheBezier,
...
begin
  ...
  FilmsDemoDM.AssignFilmsPersons;
...
begin
  ...
  { TODO : check message }
  // Use DataSetField property to obtain data for the detail View based on the currently selected film
