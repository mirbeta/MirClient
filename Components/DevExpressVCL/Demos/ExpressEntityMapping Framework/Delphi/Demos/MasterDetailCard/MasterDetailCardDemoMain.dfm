inherited MasterDetailCardDemoMainForm: TMasterDetailCardDemoMainForm
  ...
  inherited lbDescription: TLabel
    ...
    Caption = 
      ...
      'equivalent to the MasterDetailCardDemo shipped with the ExpressQ' +
      'uantumGrid Suite but replaces TClientDataSet components with Tdx' +
      'EMFDataSet components to bind grid Views to data. Click '#39'About t' +
