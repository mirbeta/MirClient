...
uses {$IFDEF RAD9PLUS}
      WinAPI.Windows, WinAPI.ActiveX, System.Classes, VCL.OleServer,
      VCL.OleCtrls, System.Win.StdVCL;
      {$ELSE}
      Windows, ActiveX, Classes, OLEServer, OleCtrls, StdVCL;
      {$ENDIF}
...
/// ** this is a Delphi 5 TLB impor goof:
// ADS_UTC_TIME = TDateTime;
  ADS_UTC_TIME = TSystemTime;
