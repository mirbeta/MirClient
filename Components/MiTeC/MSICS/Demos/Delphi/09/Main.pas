...
uses MiTeC_Dialogs, FileCtrl;

{$R *.dfm}

procedure Twnd_dm_Main.DiskMonChange;
var
  FI: TSearchrec;
begin
...
begin
  if WIN32Platform<>VER_PLATFORM_WIN32_NT then begin
    MessageDlg('This application requires NT platform.',mtWarning,[mbOK],0);
...
procedure Twnd_dm_Main.ApplicationEventsIdle(Sender: TObject;
  var Done: Boolean);
begin
