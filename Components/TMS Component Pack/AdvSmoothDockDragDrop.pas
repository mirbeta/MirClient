{************************************************************************}
{ Drag & drop interface support file for TAdvSmoothDock                  }
...
type
  ...
  TDockDropTarget = class (TInterfacedObject, IDropTarget)
  ...
  TDockDropSource = class (TInterfacedObject, IDropSource)
  private
    FNoAccept:boolean;
  protected
...
function StartTextDoDragDrop(DropSource:TDockDropSource;stxt,srtf:string;dwOKEffects: Longint; var dwEffect: Longint): HResult;
function StartColDoDragDrop(DropSource:TDockDropSource;column:integer;dwOKEffects: Longint; var dwEffect: Longint): HResult;
...
constructor TDockDropTarget.Create;
begin
  inherited Create;
  FAcceptText := true;
  FAcceptFiles := true;
...
function TDockDropTarget.DragEnter(const DataObj: IDataObject; grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
begin
...
function TDockDropTarget.DragOver(grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
var
  Allow: Boolean;
begin
  if FOk then
...
function TDockDropTarget.DragLeave: HResult;
begin
  Result := NOERROR;
  DragMouseLeave;
end;

function TDockDropTarget.Drop(const DataObj: IDataObject; grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
begin
  if FOk then
  begin
    with TEnumFormats.Create(DataObj) do
...
procedure TDockDropTarget.DropCol(pt:tpoint;col:integer);
begin
end;

procedure TDockDropTarget.DropText(pt:tpoint;s:string);
begin
end;

procedure TDockDropTarget.DropRTF(pt:tpoint;s:string);
begin
end;

procedure TDockDropTarget.DropFiles(pt:tpoint;files:tstrings);
begin
end;

procedure TDockDropTarget.DropURL(pt:tpoint;s:string);
begin
end;

procedure TDockDropTarget.DragMouseMove(pt: TPoint; var Allow: boolean; DropFormats:TDropFormats);
begin
end;

procedure TDockDropTarget.DragMouseEnter;
begin
end;

procedure TDockDropTarget.DragMouseLeave;
begin
end;
...
constructor TDockDropSource.Create;
begin
 inherited Create;
end;

procedure TDockDropSource.CurrentEffect(dwEffect: Longint);
begin
end;

procedure TDockDropSource.DragDropStop;
begin

end;

procedure TDockDropSource.QueryDrag;
begin
end;


function TDockDropSource.QueryContinueDrag(fEscapePressed: BOOL; grfKeyState: Longint): HResult;
//-------------------------------------------------------
Begin
  Result := S_OK;
...
function TDockDropSource.GiveFeedback(dwEffect: Longint): HResult;
Begin
