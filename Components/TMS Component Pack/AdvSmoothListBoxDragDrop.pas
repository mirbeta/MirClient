{************************************************************************}
{ Drag & drop interface support file for TAdvSmoothListBox               }
...
type
  ...
  TListBoxDropTarget = class (TInterfacedObject, IDropTarget)
  ...
  TListBoxDropSource = class (TInterfacedObject, IDropSource)
  private
    FNoAccept:boolean;
  protected
...
function StartTextDoDragDrop(DropSource:TListBoxDropSource;stxt,srtf:string;dwOKEffects: Longint; var dwEffect: Longint): HResult;
function StartColDoDragDrop(DropSource:TListBoxDropSource;column:integer;dwOKEffects: Longint; var dwEffect: Longint): HResult;
...
constructor TListBoxDropTarget.Create;
begin
  inherited Create;
  FAcceptText := true;
  FAcceptFiles := true;
...
function TListBoxDropTarget.DragEnter(const DataObj: IDataObject; grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
begin
  FData := DataObj;
...
function TListBoxDropTarget.DragOver(grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
var
  Allow: Boolean;
begin
  if FOk then
...
function TListBoxDropTarget.DragLeave: HResult;
begin
  FData := nil;
  Result := NOERROR;
  DragMouseLeave;
...
function TListBoxDropTarget.Drop(const DataObj: IDataObject; grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
begin
  if FOk then
  begin
    with TEnumFormats.Create(DataObj) do
...
procedure TListBoxDropTarget.DropCol(pt:tpoint;col:integer);
begin
end;

procedure TListBoxDropTarget.DropText(pt:tpoint;s:string);
begin
end;

procedure TListBoxDropTarget.DropRTF(pt:tpoint;s:string);
begin
end;

procedure TListBoxDropTarget.DropFiles(pt:tpoint;files:tstrings);
begin
end;

procedure TListBoxDropTarget.DropURL(pt:tpoint;s:string);
begin
end;

procedure TListBoxDropTarget.DragMouseMove(Source: TObject; pt: TPoint; var Allow: boolean; DropFormats:TDropFormats);
begin
end;

procedure TListBoxDropTarget.DragMouseEnter;
begin
end;

procedure TListBoxDropTarget.DragMouseLeave;
begin
end;
...
constructor TListBoxDropSource.Create;
begin
 inherited Create;
end;

procedure TListBoxDropSource.CurrentEffect(dwEffect: Longint);
begin
end;

procedure TListBoxDropSource.DragDropStop;
begin

end;

procedure TListBoxDropSource.QueryDrag;
begin
end;


function TListBoxDropSource.QueryContinueDrag(fEscapePressed: BOOL; grfKeyState: Longint): HResult;
//-------------------------------------------------------
Begin
  Result := S_OK;
...
function TListBoxDropSource.GiveFeedback(dwEffect: Longint): HResult;
Begin
