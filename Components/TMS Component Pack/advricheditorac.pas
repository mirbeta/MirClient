...
procedure TRichEditorAC.StringGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TRichEditorAC.SpeedButton1Click(Sender: TObject);
begin
  StringGrid1.RowCount := StringGrid1.RowCount + 1;

end;

procedure TRichEditorAC.SpeedButton2Click(Sender: TObject);
begin
...
procedure TRichEditorAC.FormCreate(Sender: TObject);
begin
